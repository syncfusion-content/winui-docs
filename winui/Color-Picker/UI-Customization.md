---
layout: post
title: UI Customization in WinUI Color Picker control | Syncfusion&reg;
description: Learn here all about UI customization features of Syncfusion&reg; WinUI Color Picker(SfColorPicker) control and more.
platform: WinUI
