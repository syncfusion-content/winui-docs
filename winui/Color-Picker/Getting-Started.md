---
layout: post
title: Getting Started with WinUI Color Picker | Syncfusion®
description: Learn how to get started with the Syncfusion® WinUI Color Picker control. Explore setup, features, examples, and customization options.
platform: WinUI
...
![Structure control in WinUI ColorPicker](getting-Started_images/winui-colorpicker-structure-control.png)
...
![WinUI ColorPicker control structure](getting-started_images/winui-colorpicker-control-structure.jpg)
...
![Linear lradient color in WinUI Color Picker](getting-Started_images/winui-colorpicker-linear-gradient-color.png)
...
![Selecting linear gradient Color at runtime in WinUI Color Picker](getting-Started_images/winui-colorpicker-linear-gradient-selectioncolor-.gif)
