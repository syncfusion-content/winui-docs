---
layout: post
title: Input Toolbar in WinUI AI AssistView | Syncfusion®
description: The input toolbar in WinUI AI AssistView offers quick actions through toolbar items, streamlining prompt entry and user interactions.
platform: WinUI
...
The AI AssistView control includes a toolbar feature inside the input text box. This toolbar allows users to add custom toolbar items directly within the text input area, providing quick access to frequently used actions and tools.
...
The **InputToolbarItem** in AI AssistView for the text area does not include built-in toolbar items like the response toolbar (e.g., Copy, Like, Dislike, Regenerate). However, you can add custom items using the InputToolbarItem class.
...
The **IsInputToolbarVisible** property of the [SfAIAssistView](https://help.syncfusion.com/cr/winui/Syncfusion.UI.Xaml.Chat.SfAIAssistView.html) control determines whether the input toolbar is displayed in the AI AssistView. When set to true, the input toolbar becomes visible. By default, this property is set to false.
        ...
        <DataTemplate>
            <Border CornerRadius="6">
                <ItemsControl ItemsSource="{Binding Files}">
                    ...
                    <Border BorderBrush="LightGray" BorderThickness="1" CornerRadius="4" Margin="4,0,0,0" Padding="4">
