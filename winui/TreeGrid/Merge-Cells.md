...
description: Merge Cells in SfTreeGrid enables combining adjacent cells across columns through the QueryCoveredRange event for clear and structured data presentation.
platform: winui
control: TreeGrid
documentation: ug
---
