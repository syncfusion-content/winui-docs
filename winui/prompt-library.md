...
description: Explore the AI Coding Assistants Tools Prompt Library to boost WinUI productivity with code generation, configuration examples, and contextual guidance.
...
* Run the prompt using either of the following AI tools:
  ...
  * **Skills**: Skills can also run automatically based on the query, or can be called explicitly using the `/syncfusion-winui-grid` skill.
...
How do I enable paging and sorting in the Syncfusion WinUI Grid?
{% endpromptcard %}
...
What's the code to implement full CRUD operations in Syncfusion WinUI Grid?
{% endpromptcard %}
...
Show me how to enable range selection in a Syncfusion WinUI Chart.
{% endpromptcard %}
{% promptcard Chart Types Overview %}
What chart types are available in Syncfusion WinUI Chart, and how do I configure them?
{% endpromptcard %}
...
Enable print functionality for a Syncfusion WinUI Chart component.
{% endpromptcard %}
...
The Syncfusion WinUI Schedule component helps manage events, resources, and timelines with powerful views and customization.

{% promptcards %}
{% promptcard Module Injection %}
How do I inject required modules into the Syncfusion WinUI Schedule component?
{% endpromptcard %}
...
How can I configure timezone support in the Syncfusion WinUI Schedule?
{% endpromptcard %}
...
The Syncfusion WinUI Kanban organizes tasks in columns with drag-and-drop, swimlanes, and templating for agile workflows.

{% promptcards %}
{% promptcard Data Binding %}
How do I bind local or remote data to the Syncfusion WinUI Kanban board?
{% endpromptcard %}
{% promptcard Sorting %}
...
How do I enable date range selection in the Syncfusion WinUI Calendar?
{% endpromptcard %}
