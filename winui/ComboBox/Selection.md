---
layout: post
title: Selection in WinUI ComboBox control | Syncfusion&reg;
description: Learn here all about Selection modes support in Syncfusion&reg; WinUI ComboBox (multi-select ComboBox) control and more.
platform: winui
control: SfComboBox
documentation: ug
---
