---
layout: post
title: Searching in WinUI ComboBox control | Syncfusion&reg;
description: Learn how to perform searching operation in Syncfusion&reg; WinUI ComboBox (multi-select ComboBox) control and more.
platform: winui
control: SfComboBox
documentation: ug
---
