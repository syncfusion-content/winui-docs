---
layout: post
title: Installing Syncfusion&reg; WinUI offline installer-Syncfusion&reg;
description: Learn here about how to install Syncfusion&reg; WinUI offline installer after downloading from our Syncfusion&reg; website.
platform: winui
...
# Installing Syncfusion&reg; WinUI offline installer
...
1.	Open the Syncfusion&reg; WinUI offline installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package.
...
2.	To unlock the Syncfusion &reg;offline installer, you have two options:
    ...
    **Use Unlock Key**
    ...
    Unlock keys are used to unlock the Syncfusion&reg; offline installer, and they are platform and version specific. You should use either Syncfusion&reg; licensed or trial Unlock key to unlock Syncfusion&reg; WinUI installer.
...
8.  Click the Finish button. Your system has been installed with the Syncfusion&reg; Essential Studio&reg; WinUI product.

## Installing in silent mode

The Syncfusion&reg; Essential Studio&reg; WinUI Installer supports installation and uninstallation via the command line.

### Command Line Installation

To install through the Command Line in Silent mode, follow the steps below.

1.	Run the Syncfusion&reg; WinUI installer by double-clicking it. The Installer Wizard automatically opens and extracts the package.
...
Syncfusion&reg; Essential&reg; WinUI can be uninstalled silently using the Command Line.
