...
N> Refer to the [DateTimeFormatter](https://learn.microsoft.com/en-us/uwp/api/windows.globalization.datetimeformatting.datetimeformatter?view=winrt-19041) page for more date formatting options.
