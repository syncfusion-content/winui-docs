---
layout: post
title: Customize display format in WinUI Calendar control | Syncfusion
description: This section describes how to change display format in Calendar (SfCalendar) control into WinUI application and its basic features.
platform: WinUI
control: SfCalendar
documentation: ug
---

# Change display format in WinUI Calendar

This section describes about how to customize the date, month and year format displayed in [Calendar](https://help.syncfusion.com/cr/winui/Syncfusion.UI.Xaml.Calendar.SfCalendar.html) control.
