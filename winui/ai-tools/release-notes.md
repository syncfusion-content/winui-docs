...
- The [@syncfusion/winui-assistant](https://www.npmjs.com/package/@syncfusion/winui-assistant) npm package has been migrated to the [Syncfusion.WinUI.MCP](https://www.nuget.org/packages/Syncfusion.WinUI.MCP) .NET package. As part of this transition, [@syncfusion/winui-assistant](https://www.npmjs.com/package/@syncfusion/winui-assistant) package has been deprecated and will no longer receive updates.

- The coding assistant tool identifier has been changed from **`#SyncfusionWinUIAssistant`** to **`search_docs`** for a better naming convention.