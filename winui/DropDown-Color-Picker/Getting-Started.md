---
layout: post
title: Getting Started | WinUI DropDown Color Picker | Syncfusion&reg;
description: Learn here about getting started with Syncfusion&reg; WinUI DropDown Color Picker (SfColorPicker) control, its elements, and more.
platform: WinUI
