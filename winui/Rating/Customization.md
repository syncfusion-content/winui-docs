...
The Rating control provides support for displaying a placeholder value when the rating value is zero, by using the `PlaceholderValue` property.
...
![PlaceholderValue customization in WinUI Rating control](Rating_images/winui_rating_placeholdervalue.png)
