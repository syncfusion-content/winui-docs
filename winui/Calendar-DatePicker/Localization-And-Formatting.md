...
description: Learn here all about how to localize and change format of Syncfusion WinUI Calendar Date Picker control and more.
platform: WinUI
control: SfCalendarDatePicker
documentation: ug
---

# Localize and change format in WinUI Calendar Date Picker
