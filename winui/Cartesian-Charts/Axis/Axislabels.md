...
When there are more number of axis labels, they may overlap with each other. SfChart provides support to handle the overlapping labels using the [LabelIntersectAction]() property. By default the [LabelIntersectAction]() value is [Hide]().
