...
![load-appointments-on-demand-from-visible-date-ranges-in-winui-scheduler](LoadOnDemand_Image/load-on-demand-from-visible-date-ranges-in-winui-scheduler.gif)
