...
![WinUI TreeView with MVVM selection](MVVM_images/winui-treeview-mvvm-selection.jpg)
...
![WinUI TreeView with MVVM selection](MVVM_images/winui-treeview-select-multiple-items.jpg)
