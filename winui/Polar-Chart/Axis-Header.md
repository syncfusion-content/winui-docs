...
description: Learn about the chart axis title of the Syncfusion® WinUI Chart (SfPolarChart) control and its customization options.
platform: WinUI
...
N> The polar chart supports titles for the secondary axis only.
