---
layout: post
title: Upgrade WinUI NuGet Packages to the Latest Version | Syncfusion®
description: Upgrade Syncfusion® WinUI NuGet packages to the latest version using NuGet Package Manager or Package Manager UI.
platform: winui
