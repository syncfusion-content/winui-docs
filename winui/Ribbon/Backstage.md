---
layout: post
title: Backstage in WinUI Ribbon | Syncfusion&reg;
description: Learn here all about Backstage feature, Backstage View of Syncfusion&reg; WinUI Ribbon (SfRibbon) control and more.
platform: winui
control: Ribbon
documentation: ug
---
