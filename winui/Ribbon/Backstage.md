...
N> Other icon element types, such as [BitmapIcon](https://learn.microsoft.com/en-us/uwp/api/windows.ui.xaml.controls.bitmapicon?view=winrt-28000), [FontIcon](https://learn.microsoft.com/en-us/uwp/api/windows.ui.xaml.controls.fonticon?view=winrt-28000), [PathIcon](https://learn.microsoft.com/en-us/uwp/api/windows.ui.xaml.controls.pathicon?view=winrt-28000), and [SymbolIcon](https://learn.microsoft.com/en-us/uwp/api/windows.ui.xaml.controls.symbolicon?view=winrt-28000), can also be assigned to the `Icon` property of the backstage view items.